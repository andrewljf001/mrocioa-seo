...
- 当前正式产品版本：`1.0.43`
- 当前网站部署来源提交：`41b920eea7edfaf76a99243c058e9e4f1a792b0a`
- 当前网站部署来源标签：`label-tool-v1.0.43`
...
- PDF 的整页白色画布背景不再生成白底编辑元素。
- 一维条码及其下方文字只有通过原稿模块序列 1:1 校验才转为可编辑元素；
  无法验证时保留透明原图。
- 生产回退备份：
  `/var/backups/mrocioa-labeltool/20260730-202723-before-1.0.43/`。
- 连续打印、序列号、USB 阻塞式成功回执、异常停止与人工续打原则未修改。
